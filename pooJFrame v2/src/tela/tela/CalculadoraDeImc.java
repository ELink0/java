...
public class CalculadoraDeImc extends JInternalFrame{
...
// Fazer a personalização de campo (JTextField) e também verificação
// Se for número, o campo fica azul, se for letra o campo fica vermelho
    public CalculadoraDeImc(){
    	super("Calculadora de IMC", true, true, true, true);
        setConfig();
    }

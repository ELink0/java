...
//	private JMenu jogos = new JMenu("Jogos");
	...
	private JMenuItem calculadoraDeImc = new JMenuItem("Calculadora IMC");
...
//		jogos.add(jogoForca);
		...
		utilitarios.add(calculadoraDeImc);
		...
		calculadoraDeImc.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == calculadoraDeImc) {
			if (tci == null) {
				JInternalFrame tci = new JInternalFrame();
				//CalculadoraDeImc tci = new CalculadoraDeImc();
				desk.add(tci);	
			}
